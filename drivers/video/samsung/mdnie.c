...
u16 mdnie_user_de_sharpness = 0x0000;
u16 mdnie_user_de_threshold = 0x003F;
u16 mdnie_user_cs_gain = 0x0000;
...
static ssize_t user_de_sharpness_cmd_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return sprintf(buf, "%u\n", mdnie_user_de_sharpness);
}

static ssize_t user_de_sharpness_cmd_store(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t size)
{
	struct mdnie_info *mdnie = dev_get_drvdata(dev);
	int value;
...
static ssize_t user_de_threshold_cmd_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return sprintf(buf, "%u\n", mdnie_user_de_threshold);
}

static ssize_t user_de_threshold_cmd_store(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t size)
{
	struct mdnie_info *mdnie = dev_get_drvdata(dev);
	int value;
...
static ssize_t user_cs_gain_cmd_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return sprintf(buf, "%u\n", mdnie_user_cs_gain);
}

static ssize_t user_cs_gain_cmd_store(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t size)
{
	struct mdnie_info *mdnie = dev_get_drvdata(dev);
	int value;
...
static struct device_attribute mdnie_attributes[] = {
	...
	__ATTR(user_de_sharpness_cmd, 0666, user_de_sharpness_cmd_show, user_de_sharpness_cmd_store),
	__ATTR(user_de_threshold_cmd, 0666, user_de_threshold_cmd_show, user_de_threshold_cmd_store),
	__ATTR(user_cs_gain_cmd, 0666, user_cs_gain_cmd_show, user_cs_gain_cmd_store),
	__ATTR_NULL,
};
